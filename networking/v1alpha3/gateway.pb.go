...
type Server struct {
	...
	// The maximum number of concurrent streams to allow over a single HTTP2
	// connection.
	Http2MaxConcurrentStreams int32    `protobuf:"varint,6,opt,name=http2_max_concurrent_streams,json=http2MaxConcurrentStreams,proto3" json:"http2_max_concurrent_streams,omitempty"`
	XXX_NoUnkeyedLiteral      struct{} `json:"-"`
	XXX_unrecognized          []byte   `json:"-"`
	XXX_sizecache             int32    `json:"-"`
}
...
func (m *Server) GetHttp2MaxConcurrentStreams() int32 {
	if m != nil {
		return m.Http2MaxConcurrentStreams
	}
	return 0
}
...
var fileDescriptor_067d98d02f84cc0b = []byte{
	...
	,
}
...
func (m *Server) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Http2MaxConcurrentStreams != 0 {
		dAtA[i] = 0x30
		i++
		i = encodeVarintGateway(dAtA, i, uint64(m.Http2MaxConcurrentStreams))
	}
	if m.XXX_unrecognized != nil {
		i += copy(dAtA[i:], m.XXX_unrecognized)
	}
...
func (m *Server) Size() (n int) {
	...
	if m.Http2MaxConcurrentStreams != 0 {
		n += 1 + sovGateway(uint64(m.Http2MaxConcurrentStreams))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *Server) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field Http2MaxConcurrentStreams", wireType)
			}
			m.Http2MaxConcurrentStreams = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowGateway
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Http2MaxConcurrentStreams |= int32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
