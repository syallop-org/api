...
_SERVER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='http2_max_concurrent_streams', full_name='istio.networking.v1alpha3.Server.http2_max_concurrent_streams', index=5,
